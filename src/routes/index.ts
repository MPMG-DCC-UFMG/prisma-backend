...
router.use('/project/:project_id/entity_detection', authenticateToken, entityRoute);
router.use('/project/:project_id/audio_transcription', authenticateToken, audioTranscriptionRoute);
router.use('/project/:project_id/paraphrase', authenticateToken, paraphraseRoute);
router.use('/project/:project_id/classification', authenticateToken, classificationRoute);
router.use('/project/:project_id/classification_label', authenticateToken, classificationLabelRoute);
